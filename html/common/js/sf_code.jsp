...
if( window == top ){
        ...
        superfish.b.appVersion="12.2.14.35";
...
;
  ...
  superfish.b.inj(window.document, superfish.b.site + "js/base_single_icon.js?ver=" + superfish.b.appVersion , 1);
    ...
    cr: function(ht, b, ind, hd) {
        ...
        var ms =  bs +'width:'+ this.w +'px;background: transparent; overflow: visible; z-index: 1980000000 !important; left: '+ lft +'px !important; top: '+ this.y[ind] +'px;';
        ms += (hd ? 'display: none;' : '');
